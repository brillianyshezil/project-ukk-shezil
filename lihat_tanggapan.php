...
// Jalankan query untuk mengambil data pengaduan dan tanggapan
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (empty($data['tanggapan'])): ?>
                                <p style="color: red;">Mohon bersabar, pengaduan belum ditanggapi.</p>
                            <?php else: ?>
                                <form action="" method="post" class="form-horizontal">
                                    <div class="form-group">
                                        <label>Tanggal Tanggapan</label>
                                        <input type="text" name="tgl_tanggapan" value="<?php echo htmlspecialchars($data['tgl_tanggapan']); ?>" class="form-control" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="7" name="tanggapan" readonly><?php echo htmlspecialchars($data['tanggapan']); ?></textarea>
                                    </div>
                                    <div class="form-group">
