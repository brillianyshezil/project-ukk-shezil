...
<body style="background: linear-gradient(180deg, #eacdf7 10%, #d9b3f2 100%);">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h2 class="h2 text-gray-900 mb-4"><b>Registrasi Akun!</h2></b>
                    <h1 class="h1 text-gray-900 mb-4">Aplikasi Pelaporan Pengaduan Masyarakat</h1>
                  </div>
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    ...
                    <div class="form-group">
                      <input type="text" name="telp" class="form-control form-control-user" placeholder="Masukkan Nomor Telepon">
                    </div>
