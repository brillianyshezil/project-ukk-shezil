...
if (!isset($_SESSION['nama'])) {
    // Menampilkan alert dan melakukan redirect ke halaman login
    echo "<script type='text/javascript'>
            alert('Anda Belum Login');
            window.location.href = 'index.php';  // Ganti dengan halaman login kamu
          </script>";
    exit();  // Pastikan script berhenti setelah redirect
}

// Mengecek level user, hanya admin yang diizinkan
