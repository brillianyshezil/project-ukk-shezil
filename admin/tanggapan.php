...
<body id="page-top">
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion shadow" id="accordionSidebar" style="background: linear-gradient(180deg, #6a11cb 10%, #2575fc 100%);">
                            ...
                            <form action="simpan_tanggapan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_petugas" 
                                           value="<?php echo isset($_SESSION['id_petugas']) ? $_SESSION['id_petugas'] : 'Tidak Diketahui'; ?>" 
